     ...
     <!-- <a class="navbar-brand" href="index.php"><img src="./img/logo.jpg" class="logo"></a> -->
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0">
          ...
          <a href="#" class="btn btn-outline-secondary my-2 my-sm-0">Search
         </a>
         </form>
        ...
        <div class="carousel-inner first1" style="height:500px; width: 100%;">
          ...
          <div class="carousel-item active ">
            ...
            <div class="carousel-caption d-none d-md-block ">
              <h1>Make Safe Transactions</h1>
              <p>Hassle-free Services</p>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <div class="inner">
                  <img class="card-img-top" src="./img/person.png" data-holder-rendered="true">
                </div>
    ...
    <div class="container pt-5 pb-5">
      <div class="row inner-text">
        <div class="col-md-6 text-dangers">
          ...
          <h1 class="wow mt-4 slideInDown text-secondary">24 HOURS AVAILABLE</h1>
    ...
    <footer class="pt-4 md-5  border-top">
      <div class="row">
        ...
        <div class="col-6 col-md">
          ...
          <ul class="list-unstyled text-small text-light">
            <li><a class="text-muted" href="#">sparksf@gmail.com</a></li>
            <li><a class="text-muted" href="#">8754925275</a></li>
